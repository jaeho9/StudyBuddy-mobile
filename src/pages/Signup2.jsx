        ...
        <View>
          ...
          <View style={{marginTop: 80}}>
            <TouchableOpacity
              ...
              onPress={email}
              activeOpacity={0.5}>
              <Image source={emailIcon} style={{width: 24, height: 24, marginRight:250}} />
            ...
            <TouchableOpacity
              ...
              onPress={google}
              activeOpacity={0.5}>
              <Image source={googleIcon} style={{width: 24, height: 24, marginRight:250}} />
            ...
            <TouchableOpacity
              ...
              onPress={kakao}
              activeOpacity={0.5}>
              <Image source={kakaoIcon} style={{width: 24, height: 24, marginRight:250}} />
            ...
            <TouchableOpacity
              ...
              onPress={naver}
              activeOpacity={0.5}>
              <Image source={naverIcon} style={{width: 24, height: 24, marginRight:250}} />
              <Text style={styles.buttonText}>네이버로 시작하기</Text>
            </TouchableOpacity>
          </View>
        </View>
        <View style={{ flexDirection: 'row', alignItems: 'center', margin: 50}}>
          <Text style={{ fontSize: 16, color: '#777777', marginRight:10 }}>이미 계정이 있나요? </Text>
          <TouchableOpacity onPress={login}>
            <Text style={{ fontSize: 16, fontWeight: 'bold', color: '#ff7474' }}>로그인</Text>
          </TouchableOpacity>
      </View>
      </View>
    </SafeAreaView>
